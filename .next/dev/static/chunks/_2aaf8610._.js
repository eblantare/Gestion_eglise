...
const useAuth = ()=>{
    ...
    if ($[0] !== "7926f348f833c2f417c4d9de5da1678e3132d56a4c8e24b885f13bfd9d6634a0") {
        for(let $i = 0; $i < 1; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "7926f348f833c2f417c4d9de5da1678e3132d56a4c8e24b885f13bfd9d6634a0";
    }
...
const AuthProvider = ({ children })=>{
    ...
    const register = async (data_0)=>{
        try {
            const response_0 = await fetch('http://localhost:8000/api/auth/register/', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    const refreshUser = async ()=>{
        if (!token) return;
        try {
            const response_1 = await fetch('http://localhost:8000/api/auth/me/', {
                headers: {
            ...
            if (response_1.ok) {
                ...
                localStorage.setItem('profile', JSON.stringify(data_1.profile));
                setUser(data_1.user);
                setProfile(data_1.profile);
            }
        } catch (error_1) {
...
//# sourceMappingURL=_2aaf8610._.js.map
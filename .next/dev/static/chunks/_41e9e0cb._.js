...
function LoadingSpinner() {
    ...
    if ($[0] !== "fffc5e189f9ffc38147ea013df765752459ff21941f199fb23ef6c34aae13e50") {
        for(let $i = 0; $i < 2; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "fffc5e189f9ffc38147ea013df765752459ff21941f199fb23ef6c34aae13e50";
    }
    let t0;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
...
// frontend/components/AdminGuard.tsx
__turbopack_context__.s([
    "default",
    ()=>AdminGuard
]);
...
function AdminGuard(t0) {
    ...
    if ($[0] !== "f9ed00e9a2518623b83214c15a754e138b4470db0808ce4ef5c7ec8f360195e8") {
        for(let $i = 0; $i < 11; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "f9ed00e9a2518623b83214c15a754e138b4470db0808ce4ef5c7ec8f360195e8";
    }
    const { children } = t0;
    const { isAdmin, isWebmaster, isLoading, isAuthenticated } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    let t1;
    let t2;
    if ($[1] !== isAdmin || $[2] !== isAuthenticated || $[3] !== isLoading || $[4] !== isWebmaster || $[5] !== router) {
        t1 = ({
...
_s(AdminGuard, "4LFWbV/4C8/sSRcDvraghbUXwMY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"],
...
//# sourceMappingURL=_41e9e0cb._.js.map